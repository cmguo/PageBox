...
class ConanConfig(QtConanFile):
    ...
    git_url = "git@git.100tal.com:epg_xhb_solution/talcloud_khaos_pagebox.git"
    git_branch = "develop/master"

    description = "PageBox Library"

    requires = "QtEventBus/master@cmguo/stable", "qtpromise/v0.5.0@cmguo/stable", "ShowBoard/develop@cmguo/test"
